...
//		return super.getBody();
        ...
        try {
            ...
            if (mEnty._OUT_2 || mEnty._OUT_3 || Net._OUT_2 || Net._OUT_3) {
                if (mEnty.params != null) {
                    ...
                    Log.println(Log.ERROR, mStack, Log._MESSAGE(sb));
                }
            }

            if (mEnty._OUT_3 || Net._OUT_3) {
                Log.println(Log.ERROR, mStack, Log._MESSAGE(new String(mEnty.getBody())));
            }
    ...
    private void _NETLOG_OUT(Map<String, String> headers) {
        ...
        try {
            ...
            Log.println(Log.ERROR, mStack, Log._MESSAGE("나해:", mEnty.getClass().getSimpleName(), sb.toString()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void _NETLOG_IN(Map<String, String> headers) {
        ...
        try {
            ...
            Log.println(Log.WARN, mStack, Log._MESSAGE("들해:", mEnty.getClass().getSimpleName(), sb.toString()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//                Log.i("들와:", "" + response.statusCode + "," + mEnty);
                Log.println(Log.INFO, mStack, Log._MESSAGE("들와:", "" + response.statusCode + "," + mEnty));
            }
...
//                Log.i("들와:", response.statusCode + "\n" + prettyJson(new String(response.data, HttpHeaderParser.parseCharset(response.headers, Net.UTF8))));
                Log.println(Log.INFO, mStack, Log._MESSAGE("들와:", response.statusCode + "\n" + prettyJson(new String(response.data, HttpHeaderParser.parseCharset(response.headers, Net.UTF8)))));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                Log.e("!들와:", mEnty, "" + statusCode);
                Log.println(Log.ERROR, mStack, Log._MESSAGE("!들와:", mEnty, "" + statusCode));
            }
...
//                Log.e("!들와3/5:", "" + volleyError.networkResponse);
                Log.println(Log.ERROR, mStack, Log._MESSAGE("!들와1/5:", "" + volleyError.getClass().getSimpleName()));
                Log.println(Log.ERROR, mStack, Log._MESSAGE("!들와2/5:", "" + volleyError.getMessage()));
                Log.println(Log.ERROR, mStack, Log._MESSAGE("!들와3/5:", "" + volleyError.networkResponse));
                try {
//                    Log.e("!들와4/5:", "" + volleyError.networkResponse.statusCode);
                    Log.println(Log.ERROR, mStack, Log._MESSAGE("!들와4/5:", "" + volleyError.networkResponse.statusCode));
                } catch (Exception e) {
                }
                try {
//                    Log.e("!들와5/5:", prettyJson(new String(volleyError.networkResponse.data, HttpHeaderParser.parseCharset(volleyError.networkResponse.headers, Net.UTF8))));
                    Log.println(Log.ERROR, mStack, Log._MESSAGE("!들와5/5:", prettyJson(new String(volleyError.networkResponse.data, HttpHeaderParser.parseCharset(volleyError.networkResponse.headers, Net.UTF8)))));
                } catch (Exception e) {
                }
            }
